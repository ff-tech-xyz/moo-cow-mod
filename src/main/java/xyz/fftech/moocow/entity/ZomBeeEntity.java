...
public class ZomBeeEntity extends Bee {
    ...
    protected void registerGoals() {
        // Bee wires internal goal fields during vanilla goal registration.
        // Zom-bee still extends Bee for renderer/flight behavior, so keep that
        // initialization or Bee#tick can dereference a null beePollinateGoal.
        super.registerGoals();
